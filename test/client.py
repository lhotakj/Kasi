...
if __name__ == '__main__':
    ...
    client.set("test_list", test_list)

    print("Testing SET [str_ascii] ...")
    client.set("test_str_ascii", test_str_ascii)
    ...
    read_list = client.get("test_list")
    if read_list != test_list:
        print("Failed")
        exit(1)

    print("Testing GET [str_ascii] ...")
    read_str_ascii = client.get("test_str_ascii")
    ...
    for x in range(0, load_test):
        client.set("load_test_" + str(x), str(x))
        client.get("load_test_" + str(x))
